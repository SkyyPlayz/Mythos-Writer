...
Whenever it finds a clue, it creates a **timeline suggestion**. You can confirm it, adjust it, or ignore it.

This keeps your timeline accurate without you having to track every detail.

## Big-picture timeline from your notes
...
1. Recognizes the match.
2. Links the scene to the planned event.
3. Turns the grey block into a colored block.
4. Updates the timeline.
5. Checks for overlaps or conflicts.
