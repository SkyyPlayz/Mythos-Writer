...
The originals are owner-held and git-ignored (SKY-11675). Restage them under
`design-assets/wallpapers/originals/` and check them against
`design-assets/wallpapers/PROVENANCE.json` before rebuilding.
