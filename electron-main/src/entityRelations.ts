...
const RELATION_PATTERNS: RelationPattern[] = [
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+and\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+are\s+siblings?\b/g,
    relType: 'sibling of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+is\s+married\s+to\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'married to',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+and\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+are\s+married\b/g,
    relType: 'married to',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+is\s+(?:the|a)\s+parent\s+of\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'parent of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+is\s+(?:the|a)\s+child\s+of\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'child of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+is\s+(?:the|a)\s+(?:son|daughter)\s+of\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'child of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+rules\s+(?:over\s+)?([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'rules over',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+(?:is\s+(?:a\s+)?mentor\s+(?:to|of)|mentors)\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'mentor of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+and\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+are\s+(?:allies|allied)\b/g,
    relType: 'ally of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+and\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+are\s+(?:enemies|rivals)\b/g,
    relType: 'enemy of',
    sourceGroup: 1,
    targetGroup: 2,
  },
  {
    regex: /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\s+(?:created|forged|made)\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g,
    relType: 'creator of',
    sourceGroup: 1,
    targetGroup: 2,
  },
