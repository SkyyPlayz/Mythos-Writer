...
interface Props {
  ...
  /** Rendered at the top of the Assistant tab hub view (M6 Getting Started card location). */
  gettingStartedCard?: import('react').ReactNode;
  /** Rendered after SceneAnalysisCard — the Continuity section (pass <ContinuityPanel/> from parent). */
    ...
    <section className="ahp-card ahp-card--collapsible" aria-label="Research Quick Links">
      ...
      {expanded && (
        <div className="ahp-quick-links-body">
          <p className="ahp-stub-text">Quick links to research sources (M9)</p>
        </div>
      )}
    </section>
  );
