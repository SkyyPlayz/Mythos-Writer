...
export const BUNDLED_PRESETS: Preset[] = [
  ...
  // ── Additional presets from spec §1.2 ──────────────────────────────────────
  {
    id: 'preset-fantasy-cozy-whimsical',
    name: 'Fantasy — Cozy & Whimsical',
    description: 'Low-stakes magic & community',
    axes: {
      genre: 'Fantasy',
      tone: 'joyful',
      pov: 'first',
  ...
  {
    id: 'preset-scifi-hard-technical',
    name: 'Sci-Fi — Hard & Technical',
    description: 'Plausible tech, clinical clarity',
    axes: {
      genre: 'Science Fiction',
      tone: 'serious',
  ...
  {
    id: 'preset-scifi-noir-dystopian',
    name: 'Sci-Fi — Noir & Dystopian',
    description: 'Cynical institutions, wry voice',
    axes: {
      genre: 'Science Fiction',
      tone: 'balanced',
      pov: 'first',
  ...
  {
    id: 'preset-literary-minimalist',
    name: 'Literary — Minimalist',
    description: 'Spare prose, show-don\'t-tell',
    axes: {
      genre: 'Literary',
      tone: 'serious',
      pov: 'third-limited',
  ...
  {
    id: 'preset-historical-period',
    name: 'Historical — Period Authentic',
    description: 'Period-accurate language & customs',
    axes: {
      genre: 'Historical',
      tone: 'balanced',
      pov: 'third-limited',
