...
export default function AgentsSection({
  ...
  return (
    <section className="settings-section" aria-labelledby="section-agents" data-settings-cat="agents">
      ...
      {/* S2-6: Archive Agent / Archivist settings card removed (video wins).
          Continuity remains via Continuity panel; backend agent config may still exist. */}

      {/* Beta Reader — reader-eye chapter reads; reactions land as margin comments. */}
