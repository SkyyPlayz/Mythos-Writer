        ...
        <div className="vs-section-content">
          {loading ? (
            ...
            <div className="vs-empty">
              <svg className="vs-empty-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <span className="vs-empty-headline">No notes yet</span>
              <span className="vs-empty-desc">Capture ideas, research, or worldbuilding references.</span>
              <button className="vs-empty-cta" onClick={handleCreateNote}>+ New Note</button>
            </div>
          ) : (
            tree.map((node) => (
              <NotesTreeNode
